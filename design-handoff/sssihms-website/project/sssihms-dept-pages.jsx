...
const DEPT_SUBNAV = {
  ...
  sssgh: [
    ['Overview','sssgh'], ['History','sssgh-history'], ['Statistics','multi-specialty-statistics']
  ],
  services: [
...
PAGES['cardiology-achievements'] = {
  ...
  sections:[
    ...
    { type:'quote', text:'Doctors should serve the poor with a spirit of sacrifice. There is no greater service than this.', attr:'Bhagawan Sri Sathya Sai Baba' }
  ]
};
...
PAGES['cardiology-academics'] = {
  ...
  sections:[
    { type:'cards', eyebrow:'Programmes', title:'Courses Offered', cols:3, items:[
      ...
      { title:'MSc Echocardiography & BSc Cardiac Care', desc:'Allied-health programmes in echocardiography and cardiac care technology run with the College of Nursing and Allied Health.', link:{ label:'Allied Health', page:'nursing' } }
    ] }
  ]
};
...
PAGES['ctvs-academics'] = {
  ...
  sections:[
    { type:'cards', eyebrow:'Programmes', title:'Courses Offered', cols:3, items:[
      ...
      { title:'BSc Perfusion Technology', desc:'Allied-health degree in perfusion technology run with the College of Nursing and Allied Health.', link:{ label:'Allied Health', page:'nursing' } },
...
PAGES['anes-academics'] = {
  ...
  sections:[
    { type:'cards', eyebrow:'Programmes', title:'Courses Offered', cols:3, items:[
      ...
      { title:'BSc Anesthesia Technology', desc:'Allied-health degree programme run with the College of Nursing and Allied Health.', link:{ label:'Allied Health', page:'nursing' } }
    ] }
  ]
};
...
PAGES['radiology-academics'] = {
  ...
  sections:[
    { type:'cards', eyebrow:'Programmes', title:'Courses Offered', cols:3, items:[
      { title:'DNB Radio-Diagnosis', desc:'Broad-specialty DNB training accredited by the National Board of Examinations.', link:{ label:'DNB Programmes', page:'dnb' } },
      ...
      { title:'BSc Medical Imaging Technology', desc:'Allied-health degree in imaging technology run with the College of Nursing and Allied Health.', link:{ label:'Allied Health', page:'nursing' } }
    ] }
  ]
};
...
PAGES['lab-infrastructure'] = {
  title:'Lab Infrastructure', crumb:'Services · Lab & Blood Bank', subnav:'services',
