...
PAGES['gg-biomedical'] = {
  title:'Biomedical Waste', crumb:'Go Green · Biomedical Waste', subnav:'gogreen',
  subtitle:'Safe, compliant handling of medical waste.',
  sections:[
    { type:'intro', eyebrow:'Compliance', title:'Biomedical Waste Reports', narrow:true,
      body:[
        'Biomedical waste is segregated, treated and disposed of in full compliance with the Biomedical Waste Management Rules, and the hospital publishes its periodic biomedical waste reports.'
      ], link:{ label:'Reports on the Live Site', href:'/biomedical-waste-report/' } }
  ]
};
