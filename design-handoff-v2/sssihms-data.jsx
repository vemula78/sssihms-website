...
const PAGES = {
  ...
  'patient-speak': {
    ...
    sections:[
      ...
      { type:'cards', eyebrow:'Healing Touch Archive', title:'Stories from Heart2Heart', sub:'A long-running series of patient stories from SSSIHMS, published in the Radio Sai Heart2Heart journal.', alt:true, cols:2, items:[
        { title:'Completing the Circle', desc:"It is not often that one gets a chance to express heartfelt gratitude but, I think I am lucky to have been given this chance. My parents always told me that one should be grateful for everything one receives in life but I don’t know what words to use to say thank you to this temple of healing that has given me and my family a new life, a new hope and new faith. I am an academic and pardon me if my letter begins to sound like a classroom lecture. Old habits die hard and I am all of forty five summers... ...Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01DEC08/09-healingtouch.htm' } },
        { title:'Highway to Hope', desc:"A doctor was speaking to a patient. With the rigor born out of habit, the doctor was repeating in fluent Tamil, a South Indian language. “You are being discharged today. You will receive your discharge summary in which all the instructions that you have to follow are mentioned. Follow them rigorously. Your heart valve has been replaced. It is a metal valve and has to be maintained. We are giving you a medicine, Warfarin.” The forehead of the patient puckered in confusion. The doctor picked up the discharge summary and showed him the name of the medicine printed in bold... ...Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01OCT08/09-healingtouch.htm' } },
        { title:'Destiny’s Child!', desc:"! Bangalore with the sobriquet of ‘the software capital of India’ has become the proverbial melting pot with people from various parts of the country coming over to find their destiny in the ‘binary’ world. On reflection, it is funny to see how much we have ‘coded’ our existence to the digital world. ‘Indispensable’ has taken on a new meaning with electronic gadgets taking the place of our memories and the age old pen and paper.... ...Read more", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01AUG08/09-healingtouch.htm' } },
        { title:'Dancing to Life’s New Tune!', desc:"! Those of us who have read Lewis Carroll's Alice in Wonderland will be familiar with the phrase, 'grinning like a Cheshire cat'; particularly the conversation when the cat disappears and only the grin remains. Lewis Carroll authored another equally hilarious book, Through the Looking Glass - all this humour from a man who was also a very serious mathematician. But the grin? Yes, the grin. Coming back to the grin, it was something similar to that of the cat, except the grin had a young boy's face attached to it... ...Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01JUL08/09-healingtouch.htm' } },
        { title:'A Starfish and the Ocean', desc:"A little boy playing on the beach saw this solitary grey haired veteran walking on the sands close to where the waves ebbed and flowed. Every few steps, the old man would pick up something and throw it back into the sea. The boy ran up and saw to his surprise that the old man was, in fact, throwing starfish back into the sea. His little brown eyes wide open, the boy asked, “What are you doing, Grandpa?” “What do you think?” replied the old-timer, a twinkle in his blue eyes... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01JUN08/09-healingtouch.htm' } },
        { title:'Farook’s Trials… and the Touch of Allah', desc:"The short spry man in grease stained grey overalls looked up from his efforts on the machine, nodded and stepped back. The young assistant kick started the motorbike and the engine roared to life with a slew of blue exhaust from the tail pipe. The mechanic shook his head at the sight and turned to the owner of the vehicle. “There is a problem with the petrol. The oil filter has far more sludge than normal. Change your petrol station…or you will be coming to my garage every month…” ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01MAY08/09-healingtouch.htm' } },
        { title:'Seven Tense Hours… and the Triumph of Life', desc:"It was 6.00 am in the morning when the vehicle drove up to the emergency department of SSSIHMS, Whitefield. The patient was smoothly transferred onto a stretcher, brought in, laid on the bed and connected to medical support systems. One look told the clinicians that he was all but gone; all vital signs were at their lowest ebb and there was no response to stimulus. The doctor picked up the patient response sheet, and began writing down the observations. The final score for this patient suffering from a neuro condition was an abysmal ‘3/15’. In clinical terms, he was at the threshold of the Grim Reaper’s call... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01APR08/09-healingtouch.htm' } },
        { title:'When The Door Opens…', desc:"… The paper plane glided silently over the beds and made a belly-flop landing on the nurse's head. Apparently, the parting between her tresses was the perfect air strip for that voyage of imagination. Engrossed in recording some notes in the patient's file, she was caught unawares and with a mix of surprise, irritation and curiosity, turned to glare at the bunch of children occupying the Pediatrics cubicle... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01MAR08/09-healingtouch.htm' } },
        { title:'“When Love Beckons…”', desc:"…” I shall call myself Shweta; but this is not my real name. I ask you to understand my desire to remain anonymous. It may come as a surprise to you that this story is written in the first person. Well! That is so because I wrote it myself. In fact I requested Heart2Heart to have it as it is, with some editing, if needed, but without changing the essence. I want the world to know what I have received - the greatest gift of all…the gift of Life... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01FEB08/09-healingtouch.htm' } },
        { title:'How God Built the Life of a ‘Little Builder’', desc:"’ “What brought you only to this hospital, why not another?” I asked, testing the waters carefully. “We wanted our son back…and we could not afford it elsewhere...” the directness of the reply shook me. Many would cut a religious angle and talk of the will of God…yet others would wax rhapsodic about the greatness of the hospital and Sai mission but this answer was straight on the mark…Bulls eye! “That’s all?” I asked “That’s all.” he replied... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_06/01JAN08/09-healingtouch.htm' } },
        { title:'When The Divine Sought Out the Dutiful Civil Servant…', desc:"… Fifty six year old Salil Kumar Sarangi hails from the town of Dhenkanal, the district headquarters of Dhenkanal district in the state of Orissa, in north-east India. Born into a farming family, he rose to the position of Deputy Collector of Dhenkanal district in the state government, thanks to his hard-work, sincerity and determination. Today, he holds an impeccable record as a civil servant of 25 years... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01DEC07/09-healingtouch.htm' } },
        { title:'Swapan Sees Anew and Celebrates Life', desc:"Swapan Garai’s world, in a matter few days, has changed from absolute dejection to complete joy. A young man who had left his native town of Calcutta in search of success and work, and traveled north-west to New Delhi, the capital city of India, found a small-time job in a factory making bicycle helmets which fetched him a meager Rs. 4,500 a month (approximately US $ 110). But just when he thought he had made a start and hoped to build a new life with hard work, the glimmer of hope that had begun to shine at the end of the tunnel seemed to fade away... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01OCT07/09-healingtouch.htm' } },
        { title:'From Cardiac Blues to the Family’s Blue-Eyed Boy', desc:"Samir Parida feels totally at ease in the ward and mingles with the nurses as he would with his elder sisters at home. When free from answering phone calls, Samir helps them push the medicine trolley as they dispense medicines to the patients in the ward. Sarbeshwar Parida, the proud father of the child, looks on at Samir busy in all such activities, partly in amazement but mostly with a deep sense of gratitude towards the Hospital and to its Founder, Bhagavan Baba for giving his dear son a brand new lease of life... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01SEP07/09-healingtouch.htm' } },
        { title:'Overcoming Fate with Faith', desc:"Those eyes. They shone. They shone with innocence and purity. They shone like rubies, set in marble. “Is that why she was named Ruby,” you wonder. Resting her head shyly in her father’s lap, she gives you a gentle smile. And you wonder, “How could such an innocent child go through the trauma of a heart surgery?” Her father answers for her, “Vishwaas hi sab kuch Hein” (‘Faith is everything.’)... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01AUG07/09-healingtouch.htm' } },
        { title:'New Vision, New Life', desc:". “Eight months ago, one evening I was returning home from work, and suddenly I was gripped with a never-before-felt pain in my head. I also started vomiting. After few minutes, the pain did stop, only to recur after 10 days,” says the thirty-eight year old Varanasi Sarwesvar Sharma. “I am a farmer,” continues the frail-looking father of three daughters aged eleven, eight and five years. “I did not have the time to go to the hospital; I cannot afford to go; I cannot wait long hours as it generally happens in any hospital. So I started taking Homeopathy pills, but as days passed my condition only got worse. For some inexplicable reason, my vision started deteriorating, and I had to start wearing spectacles,” Sarweswar recalls the troublesome days of his trauma. But this was only the beginning... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01JUL07/09-healingtouch.htm' } },
        { title:'He Steals Hearts While His Heart Heals…', desc:"… Heart disease can be very cruel. Ask Little Rishi. Barely into pre-school, his little heart struggled to keep up with the little bundle of energy he was. His teacher noticed him cough and sniffle frequently in class. His mother noticed that he fell ill and caught infection easily. His friends noticed that he wasn’t as big built as most of them, and barely stood one round in friendly brawls. And so “Chotu” was born... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01MAY07/09-healingtouch.htm' } },
        { title:'“Gift of Life to the Gift of God”', desc:"\" In the Viveka chudamani by Sri Adi Shankaracharya the opening verse begins with the phrase “Jantunam narajanama durlabham…” Of all forms of life, it is most difficult to attain that of a human being….The word Durlabha generally connotes rare or difficult to attain. 'Health is wealth' is an aphorism that we are taught right from kindergarten but how many of us honestly take it seriously? ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01MAR07/09-healingtouch.htm' } },
        { title:'Dawn… After a Long Dark Night!', desc:"! As a philosopher once said, “every great thing that ever happened to mankind began as a single thought in someone’s mind.” But then one has to dare to dream. The fear of failure is the biggest stumbling block in human initiative. But that was not the case with Malini. She did a one-year course at the Chitrakala Parishat of Karnataka in Tajore painting. She is now going to embark on a new journey. A journey with a companion of a lifetime… ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01FEB07/09-healingtouch.htm' } },
        { title:'The Grateful Granny from Bijapur', desc:"Though she lives in a land with such a hoary past, history seems to have little to do with her day to day living. References to the famous historical, cultural and architectural landmarks of the district bring to her old wrinkled face a placid smile that speaks volumes of her lack of sophistication... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_05/01JAN07/09-healingtouch.htm' } },
        { title:'The Gift of Life to a Good Heart', desc:"Poonam’s young life had many blessings. Her parents were devout and God-loving, so it came naturally to her to turn to God for guidance and support. As a child, her favorite deity was Goddess Saraswati. At age seven, she came into Swami’s fold. Poonam attended Bal Vikas classes in Darjeeling and was a bhajan singer in the local Sai Samithi... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01NOV06/poonam.htm' } },
        { title:'Where Love is the Therapy…', desc:"... “Your case has been posted for Monday,” said Kumar while opening the case file and scanning the contents. “Can you tell me what brings you here?” Being a medical professional, Dr. Hota summarized his condition starting from the first symptoms of cardiac disease to the present situation in succinct terms. It was impressive to watch two professionals in their individual fields in conference. It was a lesson in clinical detachment... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01OCT06/Where_Love_Is_the_Therapy.htm' } },
        { title:'Faith, Fortitude… and the Divine Touch!!!', desc:"!!! “Oh! This child has been admitted and discharged four times.” Said Dr. Anil, to no one in particular; then he looked at the sister and the officer and said, “We are unable to perform surgery on him because he has persistent and continual chest congestion, cold and cough.” Three pairs of eyes swiveled to the little baby boy. “Saab…” began the father hesitantly.... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01SEP06/pinkudas.htm' } },
        { title:'From Heartbreak to Happiness', desc:"“Patients were pouring in and the place was getting crowded. I suddenly heard a little boy’s voice from the back calling ‘Aunty, aunty’. When I turned around I saw Kotishwar, with bright shining eyes and a wide smile on his chubby face. ‘I can see, Aunty’ he said as he came running and held my hand. ‘Take me to the doctor. I want to tell him also that I can see\"... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01SEP06/omkar.htm' } },
        { title:'Amita’s Amazing Journey — From Doubt and Despair to Light and Delight', desc:"to be born healthy is the greatest of miracles. Witnessing the excess of physical ailments in the world, congenital and acquired, one must be grateful to one’s maker were one to be “normal”. To all those of us who take life for granted, who crib about every little inconvenience, every little cold and cough…to us who are “fortunate to be normal” here is a small story about the not so fortunate Amita Sahoo. ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01AUG06/amita.htm' } },
        { title:'An Unprecedented Miracle of Life… and Divine Love', desc:"“It is a healthy baby”, said the gynaecologist to Mrs. Kiran Kumari four months into her pregnancy. Her husband Mr. Karanam Srinivas Rao a photographer by profession in the port city of Visakhapatnam received the news with great joy and the birth of his first child was a moment he was looking forward to. For him everything was picture perfect now. Theirs had been a traditional arranged marriage in the year 2004 after which the couple had settled down to raise a family. The baby in her womb was their first issue and motherhood was a destiny Kumari looked forward to with great joy. Everything seemed moving in the right direction... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01JUL06/sai-sathya.htm' } },
        { title:'Jagadish Discovers Heaven and Finds Fulfillment in SSSIHMS', desc:", WF Once in a while, though, there comes along a patient for whom the Hospital and the treatment made available here are nothing short of a miracle. They strike a deep and deadly blow at one's narrow ways of thinking, fuelled by ego, self-centeredness and materialism. Mr. Jagdish Chandra Ghosh is one such individual who underwent a bypass surgery in January 2006. He came to the Hospital referred by his son, a doctor, who told him that, “If you cannot find a cure for your illness at this hospital there is no other place in the world where you can be cured.” ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01JUN06/jagadish.htm' } },
        { title:'Godfrey and Agnes Find God and Angels in Swami’s Hospital', desc:"The relief in his eyes is there for all to see, and her gentle smile says it all. Their intense struggle of six long years, culminating in their visit to Sri Sathya Sai Institute of Higher Medical Sciences, Bangalore, has finally paid off. Agnes Muwanga from Africa ) is now ready to tell how Swami’s Hospital has helped her obtain a new life... ...Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01May06/uganda.htm' } },
        { title:'The Spirited Little Teacher in the Hospital', desc:"Today I met a Teacher who taught me unquestioning faith in God. This did not happen in a classroom, there was no bespectacled professor, nor were there any clever arguments being exchanged. I was taught Faith in the Hospital ward through the little index finger of a 5-year old child... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01APR06/spirited_little_teacher.htm' } },
        { title:'“The Hospital Has Given Me… Time”', desc:"His name sounded uncommon. Even to a busy Hospital like ours that registers over a hundred Indian names each day. That, I must confess, was what got me into conversation with him. “Newand?” I heard myself say, “What does that mean?” The short, kurta-clad figure explained that it meant ‘prayer’ where he came from, a remote village a thousand miles north of Bangalore . He threw me another unfamiliar name that I could not register, but I figured he was talking of his home in far away Madhya Pradesh... ... Read More", link:{ label:'Read more', href:'http://media.radiosai.org/Journals/Vol_04/01MAR06/newand.htm' } }
      ] },
  ...
  bhagawan: {
    ...
    sections:[
      ...
      { type:'testimonials', eyebrow:"His Words", title:"On This Hospital", alt:true, cols:3, items:[
        {"quote": "What is happening in the hospital is not for today or tomorrow. This establishment will serve the poor forever. Some may have a mistaken notion that it will only be a temporary one. All the institutions established by Sai are eternal. They are an example to the whole world. July 1992.", "name": "Bhagawan Sri Sathya Sai Baba"},
        {"quote": "Come and see it for yourself the work that is being done here with the spirit of sacrifice, and experience bliss. Here you will find the poor with happiness and joy on their faces.", "name": "January 19, 2001"},
        {"quote": "This is the only hospital where you can see patients, doctors, nurses, technicians and paramedical staff with smiling faces.", "name": "February 6, 1993"},
      ] },
      { type:'testimonials', eyebrow:"His Words", title:"On Doctors and Their Calling", alt:false, cols:3, items:[
        {"quote": "Doctors wonder how all diseases are cured in our Sathya Sai Hospital. The answer is: if any action is done with a pure heart and good intentions, it is bound to be successful.", "name": "February 7, 1993"},
        {"quote": "Doctors are like the fragrant flowers and Bhagavan is the invisible thread which binds them together into a beautiful garland.", "name": "January 23, 1994"},
        {"quote": "More than the drugs doctors prescribe, the sweet, soft words they speak, the love and sympathy they evince can cure the illnesses of their patients better and quicker.", "name": "August 28, 1976"},
        {"quote": "Have a smiling face when examining your patients; talk to them sweetly. Checking the pulse with a grim face your patient may even collapse fearing the worst!.", "name": "February 6, 1993"},
        {"quote": "Doctors should infuse courage in the patients and speak soothingly radiating compassion and love. Your approach towards your patients has a greater influence on healing than the medicines you prescribe.", "name": "February 6, 1993"},
        {"quote": "Look upon patients as your own kith and kin, as your special guests and as your closest friends and attend to them lovingly and with unflinching unwavering?care.", "name": "January 21, 1994"},
        {"quote": "Remember the patient has to co-operate in their treatment so as to be cured.The patient’s recovery brings you satisfaction, joy and a sense of elation. Be grateful to the patient for all this.", "name": "August 28, 1976"},
        {"quote": "Doctors should feel a deep sense of gratitude towards society for all they have received; only then will they correctly employ their knowledge and skills.", "name": "February 7, 1993"},
        {"quote": "Treat Duty as God and Work as Worship. If you carry on your work in this spirit, the world will be a happier place for all.", "name": "February 7, 1993"},
        {"quote": "A doctor should reflect the triple qualities of sacrifice, love and compassion in treating his patients.", "name": "January 21, 1994"},
        {"quote": "A “good doctor” in due course becomes a “God doctor.” “Vaidhyo Naaraayano harih,” it is said. The doctor is Divinity itself. Doctors should render service in this spirit. June 1995.", "name": "Bhagawan Sri Sathya Sai Baba"},
        {"quote": "One with commercial outlook is not a doctor at all. In fact, he is a patient himself! The spirit of sacrifice is the hallmark of a true doctor.", "name": "July 5, 2003"},
        {"quote": "The patients’ welfare must be your topmost priority. Serve them with dedication. There is no service higher than this.", "name": "July 5, 2003"},
        {"quote": "If you aspire for the health and happiness of Swami, look after the patients well.", "name": "July 5, 2003"},
      ] },
      { type:'testimonials', eyebrow:"His Words", title:"On Health and Living", alt:true, cols:3, items:[
        {"quote": "Moderation in food, moderation in talk, and in desires and pursuits; contentment in what can be got by honest labour, eagerness to serve others and impart joy to all – these are the most powerful of all tonics…….", "name": "Septemberember 21, 1960"},
        {"quote": "Bear calumny, loss, disappointment, defeat, boldly and with equanimity; then no mental depression can overwhelm you.", "name": "September 23, 1965"},
        {"quote": "Regular prayers twice a day will give strength and courage, which can withstand illness.", "name": "October 12, 1969"},
        {"quote": "Feel that you are a hundred per cent dependent on God; He will look after you and save you from harm and injury.", "name": "October 12, 1969"},
        {"quote": "Fast one day in the week is good for the body as well as for the country.", "name": "October 12, 1969"},
        {"quote": "It is not a sign of culture to overvalue the body, by over indulging in its whims. It is a sign of barbarism.", "name": "October 12, 1969"},
        {"quote": "Through dieting alone, birds and beasts set their health allright! But, man lives on tablets and pills and injections, after venturing into forbidden realm, so far as eating and drinking are concerned.", "name": "October 12, 1969"},
        {"quote": "If everyone decides to carry on all personal services themselves, rather than depend on servants or helpers, the health situation will definitely improve and hospitals will have much less work.", "name": "October 12, 1969"},
        {"quote": "Contentment is the best tonic; why inflict on yourself the disease of greed and consume tonics to get strength, and to hanker further?.", "name": "October 12, 1969"},
        {"quote": "A sense of elation and exxcultation keeps the body free from ill health. Evil habits in which man indulges are the chief cause of disease, physical as well as mental.", "name": "July 13, 1980"},
        {"quote": "Fats consumed in large quantity are detrimental not only to one's physical health but also to one's mental health.", "name": "January 21, 1994"},
        {"quote": "Modern man is continuously in a hurry. Hurry causes worry which affects the physical health. The main cause of heart troubles may be said to be hurry, worry and curry. Curry means fatty foods.", "name": "February 6, 1993"},
        {"quote": "There will be little room for cardiac ailments if one's food habits are properly controlled and regulated.", "name": "January 21, 1994"},
        {"quote": "Birds and beasts lead natural lives, while the artificial life styles of man today takes a heavy toll on his health.", "name": "January 21, 1994"},
        {"quote": "Since mental tension is most detrimental to man's health, man should learn the art of controlling his passions and emotions.", "name": "January 21, 1994"},
        {"quote": "Every person’s physical, mental and spiritual health is ruined by bad qualities, bad thoughts and bad feelings. Hence cultivate good thoughts, good feelings & good attituders. Expel every bad thought as it arises in the mind.", "name": "July 11, 1995"},
        {"quote": "Man suffers from two types of ills, physical and mental; the one caused by the dis-equilibrium of the three tempers of Vaatha, Pittha and Sleshma (wind, bile and phlegm) and the other caused by the dis-equilibrium of the three Gunas: Sathwa, Rajas and Thamas (qualities of serenity, passion and inertia). One peculiar fact about these two types of illnesses is that the cultivation of virtue cures both. September, 1959.", "name": "Bhagawan Sri Sathya Sai Baba"},
        {"quote": "The body has to be carefully and tenderly fostered; it is a precious gift, a very complicated but well co-ordinated machine, given for achieving a laudable task.", "name": "Oct 16, 1974"},
        {"quote": "Activity must be dedicated to God, the repository of the Highest Good. Then, it will provide health for the body and mind. October 12, 1969 Prasanthi Nilayam.", "name": "Bhagawan Sri Sathya Sai Baba"},
        {"quote": "The skin of the fruit of ananda (Divine bliss) is the physical body; the succulent flesh is the muscle, bone and nerve; the hard uneatable seed is the evil that gets mixed up in life; the juice which the fruit offers, for which the tree was planted and nourished is the Bliss it shares with all.", "name": "Oct 16, 1974"},
        {"quote": "Health is necessary for gaining this world and the next, for earning worldly progress, to realise the very purpose for which the self has embodied itself in this human form, namely to become aware of its source, Paramatma. In order to attain this goal the ideals of righteousness, prosperity, moral desire and release from grief have to be practised with the help of a sound mind in a sound body.", "name": "September 30, 1981"},
        {"quote": "The head and the heart are important organs for man. The head is preoccupied with mundane phenomena, with external objects. The heart looks within. The path of external focus is termed Pravritthi Marga. All of man’s activity today, including the acquisition of knowledge and wealth, is along the Pravriti Marga which is involved with the six vices of Kama (lust), Krodha (anger), Moha (infatuation), Lobha (greed), Madha (pride) and Mathsarya (jealousy) which undergo constant changes. Because the body is associated with these qualities, it is also subject to change.But the heart which is associated Nivritthi Marga (the Inward path) remains unchanging. Truth, com­passion, love, forbearance, sympathy and sacrifice emanate from the heart. So, in human life, the head and the heart play crucial roles. These two are kept in balance by the hand. Thus, the heart, the head and the hand are the three H's which are important in understanding the human predicament.", "name": "February 7, 1993"},
        {"quote": "There should be a harmonious blend of religion, philosophy and art for man to live healthily in the world. In this context religion means the religion of love.", "name": "February 6, 1993"},
        {"quote": "The mind exercises supreme influence not only over the health of the body but on the universe too. Man is not merely a human being, he is the embodiment of Divinity.", "name": "January 23, 1994"},
        {"quote": "It is only when the body, the mind and the Spirit are in harmony that peace will prevail. Medical science should recognise the role of the mind in causing sickness.", "name": "February 6, 1993"},
      ] },
      { type:'cards', eyebrow:'Explore', title:'Life, Teachings & Projects', alt:true, cols:3, items:[
        { title:'Life', desc:'Details and important milestones of the Sri Sathya Sai Avatar.', link:{ label:'Life History', href:'https://www.srisathyasai.org/pages/sai-life-history-history.html' } },
        { title:'Writings', desc:'Bhagawan in His infinite love wrote several books \u2014 Prema Vahini, Sandeha Nivarini, Upanishad Vahini \u2014 compilations of His articles and letters on spiritual life.', link:{ label:'Writings', href:'https://www.srisathyasai.org/pages/sai-his-messages-writings.html' } },
        { title:'Poems \u2014 Text', desc:'Swami sings poems at the beginning of His discourses which contain the very essence of His teachings.', link:{ label:'Read Poems', href:'https://www.srisathyasai.org/pages/sai-his-messages-poems.html' } },
        { title:'Poems \u2014 Audio', desc:'Listen to Bhagawan singing those same poems.', link:{ label:'Listen', href:'https://archive.sssmediacentre.org/www/ssspeaks/index/poems' } },
        { title:'Discourses', desc:'Compilation of discourses delivered by Bhagawan Sri Sathya Sai Baba.', link:{ label:'Discourses', href:'https://www.srisathyasai.org/pages/sai-his-messages-speaks.html' } },
        { title:'Quotes', desc:'Compilation of quotes culled from Baba\u2019s discourses.', link:{ label:'Quotes', href:'https://www.srisathyasai.org/pages/sai-his-messages-quotes.html' } },
        { title:'Bhajans', desc:'Compilation of bhajans sung by Bhagawan.', link:{ label:'Bhajans', href:'https://archive.sssmediacentre.org/www/ssspeaks/index/bhajanas' } },
        { title:'Songs', desc:'Compilation of songs composed by Bhagawan.', link:{ label:'Songs', page:'songs-baba' } },
        { title:'Projects', desc:'Details of the various humanitarian projects undertaken by Bhagawan.', link:{ label:'Sai Projects', href:'https://www.srisathyasai.org/pages/sai-projects.html' } }
      ] }
    ]
  },
