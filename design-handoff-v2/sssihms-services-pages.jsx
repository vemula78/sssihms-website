...
PAGES['lab-infrastructure'] = {
  ...
  sections:[
    ...
    { type:'prose', eyebrow:'Outsourced Investigations', title:'When a Test Is Not Done In-House', alt:true,
      ...
      { type:'intro', eyebrow:"Laboratory", title:"Infrastructure in Detail", body:[
        ...
        "Cell counters, cytospin and coagulation analyzers help the Hematology and Clinical Pathology laboratory to perform its investigations accurately and with a short turn-around-time.",
        "The Histopathology laboratory is equipped with microtome & cyrotome as well as with the required special stains and immunohistochemistry antibodies.",
      ] },
    ]
};
  ...
  sections:[
    ...
    { type:'cta', eyebrow:'Get in Touch', title:'To Donate, or to Be Called in an Emergency',
      ...
      action:{ label:'Department of Laboratory Medicine', page:'lab-blood-bank' } },
        { type:'intro', eyebrow:"Donor Information", title:"Blood Donation in Detail", body:[
        "An average person has 5-6 liters of blood in the body.",
        "Only about 7% of blood is taken at the time of donation.",
        "In terms of volume the loss is corrected within few hours by the body.",
        "The actual bleeding time is about 6-8 minutes.",
        "The bleeding is preceded by a pre-donation check up and you are advised some rest (for 10-15 minutes) and given some refreshment after donation.",
        "The whole process takes about half an hour.",
        "The minimum time advised between two donations is 3 months for gents and 4 months for ladies.",
        "This gap is sufficient for the donor to regain the normal hemoglobin level.",
        "Your health will not suffer because of the blood you have donated.",
        "In fact, it might help stimulate the bone marrow to produce new cells.",
        "A few basic health conditions have to be met by donors.",
        ...
        "This would mean one should not do any vigorous exercise just prior to donation.",
        ...
        "Such people can contact us before donating blood",
        ...
        "If only you realize that half an hour of yours would mean a lifetime for a premature baby, a healthy heart for a blue-baby, a spirited life for a patient with brain tumor who otherwise would have lived like a vegetable, the life of bread-earner of the family, or the destiny of the young mother, you might decide that you can make the time to donate the gift of life.",
        "And ladies can donate once in 4 months.",
        "The needle is discarded immediately after donation.",
        "If you are having blood of a common group, there are many patients who need it.",
        "If your blood group is rare, there are fewer donors available to donate, so it is in short supply",
        "The average adult body has 5 – 6 litres of blood.",
        "Only 7% of this is collected during each donation.",
        "Doctors say that healthy adults may give regularly because the body quickly replaces the blood you donate.",
        "In volume, the blood is replaced within a few hours.",
        "After donation the normal daily activities can be continued",
        ...
        "The feeling of giddiness is more psychological than physiological.",
        "There is no need to be anxious about blood donation.",
        "It is safe, easy and painless",
        ...
        "The blood bank at SSSIHMS provides blood free of cost to all its patients (in fact there is no charge for the entire patient treatment).",
        "Most of the other hospitals charge the patients for the blood even though you donate voluntarily",
        "A majority of SSSIHMS patients (around 80%) come from outside Bangalore.",
        "They do not have their relatives/ friends nearby to help them in this ‘foreign’ land.",
        "You could be a good host to these needy guests by providing for this very important requirement.",
        "SSSIHMS maintains strict Quality Control in its blood collection and testing methods",
        "Blood donation is one of the best forms of philanthropy – this is not a commodity that is available for purchase.",
        "Only one person can give to another and there is no substitute for it.",
        ...
        "If found fit to donate, then you will be asked to lie down on a couch or a bed.",
        "Te collection site on your arm will be cleaned.",
        "Then using sterile equipments blood will be collected in a special plastic bag.",
        "Approximately 350ml of blood will be collected in one donation.",
  ...
  sections:[
    ...
    { type:'gallery', eyebrow:'Gallery', title:'The Department and the Campus', items:[
      ...
      { src:CDN + '2015/04/dome-tp1.jpg', caption:'Dome Area' }
        ...
        { type:'intro', eyebrow:"HMIS", title:"The System in Detail", body:[
        "The Enterprise Management (EM) from Dedalus is a comprehensive, integrated, modular, state-of-the-art, standards based HIS system.",
        "It integrates modular applications into a seamless work flow of clinical events and processes across multiple departments and functional areas.",
        "As patient events unfold, doctors, nurses and hospital staff receive information in real time as documents, images and videos, support a paperless environment.",
        "Built on a J2EE platform, EM is web based application, allowing users to access information anywhere within the hospital through web browser.",
        "Benefits of EM include flexibility and customization to match individual styles of practice so professionals can work with ease, focusing on patient care.",
        "Information, such as resource allocation and patient movement, is available to relevant users within the hospital.",
        "Outstanding clinical benefits are accompanied by substantial administrative benefits through EM.",
        ...
        "The PACS enables efficient management of all medical images captured from a variety of modalities of SSSIHMS hospitals Prasanthigram and Whitefield, providing radiologists and clinicians with instant electronic access to those exams to support the diagnostic reporting process.",
        "Over the coming months, installation will include comprehensive work flow integration of the radiology departments of all the SSSMT hospitals, infrastructure to integrate modality capture and HIS.",
        "FUJIFILM's next-generation medical imaging and information management system, SYNAPSE allows the archiving and distribution of vast amounts of image information from all modalities, managing it all with a single system.",
        "With the first comprehensive PACS (Picture Archiving and Communication System) with next-generation Web technology, SYNAPSE utilizes the latest Wavelet compression technology for on-demand compression and access of large files quickly and easily regardless of location.",
        ...
        "PACS was an essential investment in hospital’s future.",
        "Shared PACS networks and shared radiologist resources allow remote facilities to benefit from access to centralized radiologists and specialists, which greatly improve the timeliness of diagnosis and enhances patient care.",
        "The road map includes centralized storage of all images across departments including pathology, pre and post surgery clippings etc., and a seamless access to the studies from outside the facilities using a secured VPN.",
        "In order to to provide the Cost effective procurement of medical consumables, a comprehensive Inventory Management System was developed in-house by HMIS.",
        "The system helps in making decisions in purchasing and maintaining optimal stock of medical consumables through reorder levels.",
        "Apart from that IMS provides for tracking of the items up to the point of consumption.",
      ] },
    ]
};
})();
