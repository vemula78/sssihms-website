...
PAGES['nesu-dnb'] = {
  title:'DNB Neurosurgery', crumb:'Departments · Neurosurgery · DNB', subnav:'neurosurgery', icon:R.imgNESU,
...
PAGES['anes-dnb'] = {
  title:'Anaesthesia DNB Residency Programme', crumb:'Departments · Anesthesiology · DNB', subnav:'anesthesiology', icon:R.imgANES,
